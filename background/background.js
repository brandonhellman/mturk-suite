...
async function hitExportPlain (args, request, sender, sendResponse) {
  const hit = args.hit
...
async function hitExportBBCode (args, request, sender, sendResponse) {
  const hit = args.hit
  const review = await requesterReviewsGetExport(hit.requester_id)
  const reviewsTemplate = []
...
async function hitExportMarkdown (args, request, sender, sendResponse) {
  const hit = args.hit
  const review = await requesterReviewsGetExport(hit.requester_id)
  const reviewsTemplate = []
...
async function hitExportTurkerHub (args, request, sender, sendResponse) {
